...
class SettingsGroup
{
	...
	public function __construct($setting_group)
	{
		...
		if (!is_array($wp_registered_settings) || empty($wp_registered_settings[$this->setting_group_name])) {
	...
	public function register_setting()
	{
		...
		add_action("pre_update_option_{$this->setting_group_name}", [$this, 'pre_update_option']);
	}
